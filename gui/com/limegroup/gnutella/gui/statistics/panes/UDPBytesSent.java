...
/**
 * This class is a <tt>PaneItem</tt> for the total number of UDP bytes 
 * passed.
 */
public final class UDPBytesSent extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPBytesSent(final String key) {
		...
		registerStatistic(SentMessageStatBytes.UDP_QUERY_REPLIES,
		...
		registerStatistic(SentMessageStatBytes.UDP_PING_REPLIES,
		...
		registerStatistic(SentMessageStatBytes.UDP_ROUTE_TABLE_MESSAGES,
