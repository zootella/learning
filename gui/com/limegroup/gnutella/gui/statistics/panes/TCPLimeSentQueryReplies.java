 ...
 */
public final class TCPLimeSentQueryReplies extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public TCPLimeSentQueryReplies(final String key) {
		super(key);
		registerStatistic(SentMessageStat.TCP_QUERY_REPLIES,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeSentMessageStat.TCP_QUERY_REPLIES,
