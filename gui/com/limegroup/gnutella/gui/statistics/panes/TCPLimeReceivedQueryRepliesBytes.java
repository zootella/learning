 ...
 */
public final class TCPLimeReceivedQueryRepliesBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public TCPLimeReceivedQueryRepliesBytes(final String key) {
		super(key, GraphAxisData.createKilobyteGraphData());
		registerStatistic(ReceivedMessageStatBytes.TCP_QUERY_REPLIES,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeReceivedMessageStatBytes.TCP_QUERY_REPLIES,
