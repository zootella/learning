 ...
 */
public final class UDPLimeSentMessages extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeSentMessages(final String key) {
		super(key);
		registerStatistic(SentMessageStat.UDP_ALL_MESSAGES,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeSentMessageStat.UDP_ALL_MESSAGES,
