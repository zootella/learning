 ...
 */
public final class UDPLimeReceivedQueryReplies extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeReceivedQueryReplies(final String key) {
		super(key);
		registerStatistic(ReceivedMessageStat.UDP_QUERY_REPLIES,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeReceivedMessageStat.UDP_QUERY_REPLIES,
