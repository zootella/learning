 ...
 */
public final class UDPLimeReceivedPushRequestsBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeReceivedPushRequestsBytes(final String key) {
		...
		registerStatistic(LimeReceivedMessageStatBytes.UDP_PUSH_REQUESTS,
