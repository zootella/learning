 ...
 */
public final class MulticastLimeReceivedPushRequestsBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeReceivedPushRequestsBytes(final String key) {
		...
		registerStatistic(LimeReceivedMessageStatBytes.MULTICAST_PUSH_REQUESTS,
