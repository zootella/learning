 ...
 */
public final class UDPLimeSentBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeSentBytes(final String key) {
		...
		registerStatistic(LimeSentMessageStatBytes.UDP_ALL_MESSAGES,
