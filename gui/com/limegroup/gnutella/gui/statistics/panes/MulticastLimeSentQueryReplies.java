 ...
 */
public final class MulticastLimeSentQueryReplies extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeSentQueryReplies(final String key) {
		super(key);
		registerStatistic(SentMessageStat.MULTICAST_QUERY_REPLIES,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeSentMessageStat.MULTICAST_QUERY_REPLIES,
