 ...
 */
public final class UDPLimeSentQueryRepliesBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeSentQueryRepliesBytes(final String key) {
		...
		registerStatistic(LimeSentMessageStatBytes.UDP_QUERY_REPLIES,
