 ...
 */
public final class TCPLimeReceivedQueryReplies extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public TCPLimeReceivedQueryReplies(final String key) {
		super(key);
		registerStatistic(ReceivedMessageStat.TCP_QUERY_REPLIES,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeReceivedMessageStat.TCP_QUERY_REPLIES,
