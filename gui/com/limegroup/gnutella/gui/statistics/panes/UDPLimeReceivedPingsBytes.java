 ...
 */
public final class UDPLimeReceivedPingsBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeReceivedPingsBytes(final String key) {
		...
		registerStatistic(LimeReceivedMessageStatBytes.UDP_PING_REQUESTS,
