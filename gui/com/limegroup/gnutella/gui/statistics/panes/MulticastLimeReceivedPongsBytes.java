 ...
 */
public final class MulticastLimeReceivedPongsBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeReceivedPongsBytes(final String key) {
		...
		registerStatistic(LimeReceivedMessageStatBytes.MULTICAST_PING_REPLIES,
