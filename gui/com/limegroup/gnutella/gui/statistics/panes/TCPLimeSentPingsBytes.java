 ...
 */
public final class TCPLimeSentPingsBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public TCPLimeSentPingsBytes(final String key) {
		...
		registerStatistic(LimeSentMessageStatBytes.TCP_PING_REQUESTS,
