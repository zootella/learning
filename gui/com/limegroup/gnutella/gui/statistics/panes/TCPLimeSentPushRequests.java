 ...
 */
public final class TCPLimeSentPushRequests extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public TCPLimeSentPushRequests(final String key) {
		super(key);
		registerStatistic(SentMessageStat.TCP_PUSH_REQUESTS,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeSentMessageStat.TCP_PUSH_REQUESTS,
