 ...
 */
public final class MulticastLimeSentPongs extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeSentPongs(final String key) {
		super(key);
		registerStatistic(SentMessageStat.MULTICAST_PING_REPLIES,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeSentMessageStat.MULTICAST_PING_REPLIES,
