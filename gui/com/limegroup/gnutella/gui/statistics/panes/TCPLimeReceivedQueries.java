 ...
 */
public final class TCPLimeReceivedQueries extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public TCPLimeReceivedQueries(final String key) {
		super(key);
		registerStatistic(ReceivedMessageStat.TCP_QUERY_REQUESTS,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeReceivedMessageStat.TCP_QUERY_REQUESTS,
