 ...
 */
public final class TCPLimeSentMessages extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public TCPLimeSentMessages(final String key) {
		super(key);
		registerStatistic(SentMessageStat.TCP_ALL_MESSAGES,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeSentMessageStat.TCP_ALL_MESSAGES,
