 ...
 */
public final class TCPLimeReceivedPings extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public TCPLimeReceivedPings(final String key) {
		super(key);
		registerStatistic(ReceivedMessageStat.TCP_PING_REQUESTS,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeReceivedMessageStat.TCP_PING_REQUESTS,
