 ...
 */
public final class MulticastLimeSentPongsBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeSentPongsBytes(final String key) {
		...
		registerStatistic(LimeSentMessageStatBytes.MULTICAST_PING_REPLIES,
