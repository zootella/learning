 ...
 */
public final class MulticastLimeReceivedQueryRepliesBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeReceivedQueryRepliesBytes(final String key) {
		...
		registerStatistic(LimeReceivedMessageStatBytes.MULTICAST_QUERY_REPLIES,
