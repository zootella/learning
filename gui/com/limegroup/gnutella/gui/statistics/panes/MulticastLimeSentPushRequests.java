 ...
 */
public final class MulticastLimeSentPushRequests extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeSentPushRequests(final String key) {
		super(key);
		registerStatistic(SentMessageStat.MULTICAST_PUSH_REQUESTS,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeSentMessageStat.MULTICAST_PUSH_REQUESTS,
