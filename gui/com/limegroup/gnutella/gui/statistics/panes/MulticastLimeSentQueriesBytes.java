 ...
 */
public final class MulticastLimeSentQueriesBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeSentQueriesBytes(final String key) {
		...
		registerStatistic(LimeSentMessageStatBytes.MULTICAST_QUERY_REQUESTS,
