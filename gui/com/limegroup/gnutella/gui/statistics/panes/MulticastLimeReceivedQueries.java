 ...
 */
public final class MulticastLimeReceivedQueries extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeReceivedQueries(final String key) {
		super(key);
		registerStatistic(ReceivedMessageStat.MULTICAST_QUERY_REQUESTS,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeReceivedMessageStat.MULTICAST_QUERY_REQUESTS,
