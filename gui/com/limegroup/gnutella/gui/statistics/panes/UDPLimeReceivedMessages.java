 ...
 */
public final class UDPLimeReceivedMessages extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeReceivedMessages(final String key) {
		super(key);
		registerStatistic(ReceivedMessageStat.UDP_ALL_MESSAGES,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeReceivedMessageStat.UDP_ALL_MESSAGES,
