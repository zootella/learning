 ...
 */
public final class MulticastLimeReceivedPushRequests extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeReceivedPushRequests(final String key) {
		super(key);
		registerStatistic(ReceivedMessageStat.MULTICAST_PUSH_REQUESTS,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeReceivedMessageStat.MULTICAST_PUSH_REQUESTS,
