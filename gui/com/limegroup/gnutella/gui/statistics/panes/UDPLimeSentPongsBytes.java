 ...
 */
public final class UDPLimeSentPongsBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeSentPongsBytes(final String key) {
		...
		registerStatistic(LimeSentMessageStatBytes.UDP_PING_REPLIES,
