 ...
 */
public final class UDPLimeReceivedQueryRepliesBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeReceivedQueryRepliesBytes(final String key) {
		...
		registerStatistic(LimeReceivedMessageStatBytes.UDP_QUERY_REPLIES,
