 ...
 */
public final class UDPLimeReceivedBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public UDPLimeReceivedBytes(final String key) {
		...
		registerStatistic(LimeReceivedMessageStatBytes.UDP_ALL_MESSAGES,
