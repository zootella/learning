 ...
 */
public final class MulticastLimeReceivedPings extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastLimeReceivedPings(final String key) {
		super(key);
		registerStatistic(ReceivedMessageStat.MULTICAST_PING_REQUESTS,
						  GUIMediator.getStringResource("STATS_ALL_CLIENTS"));  
		registerStatistic(LimeReceivedMessageStat.MULTICAST_PING_REQUESTS,
