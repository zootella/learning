 ...
 */
public final class TCPLimeReceivedQueriesBytes extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public TCPLimeReceivedQueriesBytes(final String key) {
		...
		registerStatistic(LimeReceivedMessageStatBytes.TCP_QUERY_REQUESTS,
