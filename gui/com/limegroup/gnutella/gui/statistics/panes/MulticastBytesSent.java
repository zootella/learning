...
/**
 * This class is a <tt>PaneItem</tt> for the total number of Multicast bytes 
 * passed.
 */
public final class MulticastBytesSent extends AbstractMessageGraphPaneItem {
	 ...
	 */
	public MulticastBytesSent(final String key) {
		super(key, GraphAxisData.createKilobyteGraphData());
		registerStatistic(SentMessageStatBytes.MULTICAST_QUERY_REQUESTS,
		...
		registerStatistic(SentMessageStatBytes.MULTICAST_PING_REPLIES,
			GUIMediator.getStringResource("GENERAL_PING_REPLY_LABEL"));
		registerStatistic(SentMessageStatBytes.MULTICAST_PUSH_REQUESTS,
			GUIMediator.getStringResource("GENERAL_PUSH_REQUEST_LABEL"));
		registerStatistic(SentMessageStatBytes.MULTICAST_ROUTE_TABLE_MESSAGES,
