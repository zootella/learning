...
public final class MaximumUploadsPaneItem extends AbstractPaneItem {
	 ...
	 * this <tt>PaneItem</tt>.
	 */
	private final String OPTION_LABEL = "OPTIONS_UPLOAD_MAX_NUMBER_LABEL";
	 ...
	 */
	public MaximumUploadsPaneItem(final String key) {
		super(key);

		_maxUploadsField = new SizedWholeNumberField();
		LabeledComponent comp = 
            new LabeledComponent(OPTION_LABEL, _maxUploadsField,
